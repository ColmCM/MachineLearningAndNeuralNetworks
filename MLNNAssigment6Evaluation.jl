...
begin
	directory = "../outputs/20240111_1629/"
...
# ╔═╡ 5dba4a11-8af6-4406-8cef-dc86c403d65e
# When 

# The pdrop is 0.30 as dropping too many words loses context. Setting it high can lead to a lot words lost in the training, which can lead to the meaning of these words losing context. Example: Look at how the context of Great is used differently here: I have an exam. Great. - I got 100% in my exam! Great! 
#It is at 0.3 to introduce some level of randomness to the model while still ensuring that there's enogugh Context to work with.

#Overtraining occurs when a model fits the training data a bit too excessively. This compromises its ability to generalize to new data. Regularization prevents this, and is why I've reduced the size to 20.
