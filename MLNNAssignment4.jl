...
# ╔═╡ 08bb0a3d-be79-4559-b9ca-ec1a72e849c8
begin
	using PlutoUI
	using Latexify
	TableOfContents()
...
# ╔═╡ b998c7c5-6cc6-4a5e-9ecf-7c91ee0db419
md"""
# Training a simple neural network
"""

# ╔═╡ efc60ece-38a6-46bf-bab2-bc7dadef286e
md"""
![image](https://github.com/rgreilly/images/assets/1801654/a68b3afd-2374-4db2-9072-ea318622abfc)
"""

# ╔═╡ 3accede3-f55f-4afb-afc0-f536eae42499
md"""
## Define a generic NN layer
"""

# ╔═╡ d99e66d7-1036-403a-8d7f-ee8b091eab2d
md"""
Use a struct to define a generic layer of a neural network.
The struct fields comprise: 
...
# ╔═╡ 7065bc19-8e3d-4369-be01-ebf5ecb420bf
md"""
...
The final function definition in the block serves to propagate its vector argument `x` through the entire network.  For clarity, the expression `reduce((left,right)->right∘left, m.layers)(x)`
...
# ╔═╡ 2f9f96b2-1284-4f3c-97d5-8311358f2768
begin
	struct Network
		layers::Vector{Layer} 
...
# ╔═╡ dbcfd220-3621-4860-bfe3-79bf8dafaf2a
begin
	inputs1 = collect(-3:0.1:3) # create training data
	targetOutput1 = sin.(inputs1)
	...
	twoLayerNeuralNet = Network(Layer(1,100,ReLu), Layer(100,1)) 
		# instantiate a two-layer network
end

# ╔═╡ be7e5188-ceda-47fe-b660-363857e5720a
reduce((x,y)->x*y, [1,2,3,4]);

# ╔═╡ 69f42d5e-cfaa-47ec-991e-4c18221ca092
begin
	f(x) = x^2
	g(x) = x+1
...
# ╔═╡ ea8f32dd-6632-4f1d-904e-8ca1cffd0441
md"""
## Create a two-layer network
"""

# ╔═╡ 0d6f4318-a22e-48ad-924a-c7c8f4180405
md"""
...
# ╔═╡ 964321c6-c9e2-47c2-8d05-e0b73e5f2d2f
begin
	...
	# Plot the function
	plot(x_values, y_values, label="ReLU", xlabel="x", ylabel="ReLU(x)", title="ReLU activation function", legend=false)

end

# ╔═╡ 59abfa6c-b5ae-41dc-80a3-6abec2ffede0
md"""
The error (or loss) function is the mean squared difference between the actual output and target output.
"""

# ╔═╡ 25c03e7e-e1fe-40eb-a29c-ba7c9de7b031
latexify("mse(x,y) = sum((x .- y).^2)/length(x)")

# ╔═╡ c237f354-cf35-46e3-b19c-27e16aaf397f
md"""
## Train on 7-segment digit representations
"""

# ╔═╡ 0f487a8e-8784-4cae-b295-b2b3ec6fe48c
md"""
The task

-The 10 digits 0 to 9 can be represented on an LED using the above pattern of segments.
-Your task is to train a neural network to take a binary representation of the display as
input and produce the number it represents as output. For example, the number “1”
can be represented as the seven-element integer vector [0 1 1 0 0 0 0], “2” as [1 1 0 1 1 0
1], and so on. -The output classification can be represented as a 10-element vector,
such that the input representing “2” will produce the output vector [0 0 1 0 0 0 0] and a
“3” input will give an output of [0 0 0 1 0 0 0]. -Note that the elements of the output
vector can be within a 0.1 tolerance of the target value.
...
# ╔═╡ cd834d86-962c-4ec2-833b-626a5a063c1e
md"""
...
# ╔═╡ fbdbdeac-e41a-474e-8ef9-186b5937a859
md"""
## Plot the result
"""

# ╔═╡ fecaeb5d-77b1-40ad-8d1c-2265698351ad
md"""
Move the slider to observe training progress.
"""

# ╔═╡ d3a8288d-85c7-41fe-aae7-ab9ad217f653
@bind plotIndex Slider(1:10:1000, default=1000)

# ╔═╡ 53eb92d6-ec8d-4411-afef-264006c4f652
begin
	#using Plots
	...
	plot!(outputPlot, inputs, netOutput[plotIndex],
...
# ╔═╡ b88e09a3-a025-461f-8b9d-591f4e2ec2cc
plot(lossCurvePlot)

# ╔═╡ d1659cf9-9b6f-403c-bacd-3159e24bda93
begin
...
# ╔═╡ f354a6d6-ef17-4fb6-902a-7508e8281193
begin
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "f8de77bd67d82363b6ff3dd8b16f3d2f4c46367a"
