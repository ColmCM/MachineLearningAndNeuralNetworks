...
#Note, Code was acting extremely weird for me. Sorry for bad quality assignment.
...
# ╔═╡ 2675fbc0-ccdd-4fd0-8197-d64b8936f943
md"""
...
# ╔═╡ 400c7c0a-ad3f-4edb-b770-882f4e267304
md"""
!!! tip
...
# ╔═╡ b2de8fda-6e01-4c8c-8ee6-b7ba7e6658e5
md"""
!!! tip
...
#@bind idx Slider(1:500:50000, default = 50000)
#function update_image()
#    display(display_image(train_x[idx.value]))

# ╔═╡ 624b4051-4ced-428a-9f15-c8f9d91ba932
md"""
!!! tip
...
# ╔═╡ 1cd17fd2-1153-4c3a-9019-8496a26f15c7
md"""
!!! tip
...
# ╔═╡ 3e9cf943-ee5a-4899-9808-4b00d1c1a2e9
md"""
!!! tip
...
begin
	...
	valset = 49001:50000
	valX = Flux.gpu(train_x[:,:,:,valset])
	valY = Flux.gpu(labels2[:, valset])
end;
...
image1(x) = colorview(RGB, permutedims(x, (3, 2, 1)))
...
# ╔═╡ 9b1adde5-c16b-4613-a52b-d36ee92acb5a
md"""
!!! tip
...
begin
	using DataFrames
	DataFrame(accuracy=(class_correct ./ class_total), label=[get(label_mapping, i, "") for i in 0:9])
end

# ╔═╡ 1de6fb09-6159-452d-be05-3ccc40b9d461
md"""
!!! tip
...
begin
	...
	test_indices = partition(1:10000, 1000, 1000)
	test = [(Flux.gpu(test_x[:,:,:,i]), Flux.gpu(test_labels[:,i])) for i in test_indices]
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "493f15f4fca3652e2b3c5bd0dbbf7a14fd8b3fab"
